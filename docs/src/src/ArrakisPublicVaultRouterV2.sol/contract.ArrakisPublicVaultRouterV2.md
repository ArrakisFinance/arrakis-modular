...
[Git Source](https://github.com/ArrakisFinance/arrakis-modular/blob/4485c572ded3a830c181fa38ceaac13efe8eb7f1/src/ArrakisPublicVaultRouterV2.sol)
...
*bytes32(0) should be used to set valantis resolver.*
...
```solidity
function getModuleID(address module_) public view returns (bytes32);
```
