...
[Git Source](https://github.com/ArrakisFinance/arrakis-modular/blob/4485c572ded3a830c181fa38ceaac13efe8eb7f1/src/interfaces/IArrakisPublicVaultRouterV2.sol)
...
```solidity
function resolvers(bytes32 id_) external view returns (address);
```
