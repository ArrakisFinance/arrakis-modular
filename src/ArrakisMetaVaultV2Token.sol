...
import {ArrakisMetaVaultV2} from "./ArrakisMetaVaultV2.sol";
...
contract ArrakisMetaVaultV2Token is IArrakisMetaToken, ArrakisMetaVaultV2, ERC20 {
    ...
    ) ArrakisMetaVaultV2(token0_, token1_, owner_, init0_, init1_, module_) {
        _name = name_;
        _symbol = symbol_;
    }
