...
//  Temp Aerodrome Module Implementation Address :
//   0xA8098dA01ACb87C85f8E0094Ff23213394150785
...
contract DAerodromeModule is CreateXScript {
    uint88 public version = uint88(
        uint256(
            keccak256(abi.encode("Aerodrome Module version Aero Manager Balance"))
        )
    );
    ...
    function run() public {
        ...
        address aeroModule = computeCreate3Address(salt, msg.sender);
